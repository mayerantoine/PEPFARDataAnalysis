...
print_partner <- function(data,p,i) {
     tab <- filter(fy2017_results, mechanism == p & indicator == i) %>% 
         select (facility,FY17Results,FY17TARGET,performance)
     pandoc.header(" ", level = 3)
     pandoc.header(paste(i, "performance by site"), level = 4)
...
print_partner(fy2017_results,cdc[6],ind[1])
