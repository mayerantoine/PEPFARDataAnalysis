...
## @knitr load_prepare_testing_data
#  TESTING DATA
...
## load_prepare_hts_yield_data
# HTS_YIELD
positifs <- read_csv("mesi_report_positifs.csv",skip =1)
names(positifs) <-  make.names(names(positifs))
...
write.csv(htc_yield,"htc_yield.csv")
write.csv(fy2017_net_new,"fy2017_net_new.csv")
